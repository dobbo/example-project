...
a persistence unit "projectPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "project/pom.xml":
...
artifacts ("project-ejb.jar" and "project-web.war") are already built. You can build
